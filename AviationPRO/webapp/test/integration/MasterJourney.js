sap.ui.define([
	...
	opaTest("MasterList Filtering on TotalPrice less than 100", function (Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("TotalPrice").
	...
	opaTest("MasterList Filtering on TotalPrice more than 100", function (Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 CurrencyCode").
		and.iPressOKInViewSelectionDialog();
