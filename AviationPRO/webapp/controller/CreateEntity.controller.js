sap.ui.define([
	...
	return BaseController.extend("AviationUI.AviationPRO.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("TravelProcessor", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("TravelProcessor", oData);
